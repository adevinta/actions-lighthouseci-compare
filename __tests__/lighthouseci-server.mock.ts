...
app.get('/v1/projects/:projectId/builds/:buildId', conditionalBasicAuth, (req, res) => {
...
app.get('/v1/projects/:projectId/builds/:buildId/ancestor', conditionalBasicAuth, (req, res) => {
  res.json(ancestorBuildFixture)
})
app.get('/v1/projects/:projectId/builds/:buildId/runs', conditionalBasicAuth, (req, res) => {
